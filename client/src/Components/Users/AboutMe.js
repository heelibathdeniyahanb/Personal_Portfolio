      ...
      <div className='flex flex-col md:flex-row items-center md:items-start text-black'>
        ...
        <div className={`w-full md:w-1/2 md:pl-8 transition-all duration-1000 ease-in-out ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
          ...
          <p className="text-lg mb-6 leading-relaxed">
            I am a calm and relaxed individual with a strong enthusiasm for coding. I have a deep love for music and enjoy traveling, especially to green environments. I am a courageous person who is always eager to learn new things and advance my coding skills.
          </p>
